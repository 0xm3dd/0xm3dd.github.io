...
![Deploy](https://github.com/0xm3dd/0xm3dd.github.io/actions/workflows/deploy.yml/badge.svg)

> *"Learning is a continuous process."*

Welcome to my digital headquarters. This repository hosts the source code for my personal cybersecurity portfolio and blog. Here I document my journey through Capture The Flag (CTF) challenges, machine walkthroughs, and security research.

**🌐 Live Uplink:** [https://0xm3dd.github.io](https://0xm3dd.github.io)
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/0xm3dd/0xm3dd.github.io.git](https://github.com/0xm3dd/0xm3dd.github.io.git)
    cd 0xm3dd.github.io
    ```
